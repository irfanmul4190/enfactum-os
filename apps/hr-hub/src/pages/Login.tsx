      ...
      <div className="glass-card p-10 max-w-md w-full text-center space-y-8">
        <div className="flex items-center justify-center gap-3">
          ...
          <div className="text-left">
            <h1 className="text-2xl font-bold text-foreground">HR Hub</h1>
            <p className="text-xs text-muted-foreground">by Enfactum</p>
          </div>
        </div>
        ...
        <p className="text-xs text-muted-foreground">
          Only authorized @enfactum.com accounts can access HR Hub
        </p>
      </div>
    </div>
  );
