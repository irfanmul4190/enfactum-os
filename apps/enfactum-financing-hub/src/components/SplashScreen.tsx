...
export function SplashScreen({ children }: SplashScreenProps) {
  ...
  useEffect(() => {
    // Show splash for 1.6s, then fade over 0.6s
  ...
  return (
    <>
      {phase !== "done" && (
        ...
        >
          ...
          <div
            ...
            style={{
              animation: "splash-rise 0.7s cubic-bezier(0.34, 1.56, 0.64, 1) forwards",
            }}
          >
      ...
      {/* App renders underneath immediately — visible once splash fades */}
      <div
        style={{
